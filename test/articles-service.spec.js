...
describe.skip('Articles service object', function() {
    ...
    //describe('getAllArticles()', ()=> {
        // context() is functionally equivelant to describe() but provides
        // a semantic cue that a context is being set for a group of tests
    context(`Given 'blogful_articles' has data`, ()=> {
        ...
        it(`getAllArticles() resolves all articles from 'blogful_articles' table`, ()=> {
            //Test that the function gets all data from the table
